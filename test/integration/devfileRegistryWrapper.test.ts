...
suite('Devfile Registry Wrapper tests', function () {
    ...
    // NOTE: downloadStackExtraFiles() was removed in favor of DevfileResolver.resolve()
    // The functionality is now tested in test/integration/devfileResolver.test.ts
});
