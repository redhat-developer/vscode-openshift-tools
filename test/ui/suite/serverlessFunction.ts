...
import { ActivityBar, EditorView, NotificationType, SideBarView, ViewSection, Workbench } from 'vscode-extension-tester';
...
export function testCreateServerlessFunction(path: string) {
    describe('Serverless Function', function() {
        ...
        before(async function context() {
            ...
            for (const item of [VIEWS.appExplorer, VIEWS.compRegistries, VIEWS.components, VIEWS.debugSessions]) {
