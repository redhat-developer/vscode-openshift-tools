...
export function activate(context: vscode.ExtensionContext) {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('openshift.project.delete.palette', (context) => execute(Project.delProject, context)),
        vscode.commands.registerCommand('openshift.app.delete.palette', (context) => execute(Application.delApplication, context)),
