...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('clusters.openshift.deploy.dc.showLog', (context) => execute(DeploymentConfig.dcShowLog, context)),
        vscode.commands.registerCommand('clusters.openshift.deploy.dc.showLog.palette', (context) => execute(DeploymentConfig.dcShowLog, context)),
