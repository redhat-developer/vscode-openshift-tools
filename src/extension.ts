...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('clusters.openshift.deploy.rc.showLog', (context) => execute(DeploymentConfig.rcShowLog, context)),
        vscode.commands.registerCommand('clusters.openshift.deploy.rc.showLog.palette', (context) => execute(DeploymentConfig.rcShowLog, context)),
