...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('clusters.openshift.build.openConsole.palette', (context) => execute(Console.openBuildConfig, context)),
        ...
        vscode.commands.registerCommand('clusters.openshift.deployment.openConsole.palette', (context) => execute(Console.openDeploymentConfig, context)),
        ...
        vscode.commands.registerCommand('clusters.openshift.imagestream.openConsole.palette', (context) => execute(Console.openImageStream, context)),
