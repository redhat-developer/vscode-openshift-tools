...
import { ImageStream } from './k8s/imageStream';
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('clusters.openshift.build.openConsole', (context) => execute(Build.openConsole, context)),
        vscode.commands.registerCommand('clusters.openshift.deployment.openConsole', (context) => execute(DeploymentConfig.openConsole, context)),
        vscode.commands.registerCommand('clusters.openshift.imagestream.openConsole', (context) => execute(ImageStream.openConsole, context)),
