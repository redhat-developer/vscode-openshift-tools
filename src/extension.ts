...
export async function activate(extensionContext: vscode.ExtensionContext): Promise<void> {
    ...
    const disposable = [
        ...
        vscode.commands.registerCommand('openshift.storage.describe', (context) => execute(Storage.describe, context)),
        vscode.commands.registerCommand('openshift.storage.describe.palette', (context) => execute(Storage.describe, context)),
        ...
        vscode.commands.registerCommand('openshift.url.describe', (context) => execute(Url.describe, context)),
        vscode.commands.registerCommand('openshift.url.describe.palette', (context) => execute(Url.describe, context)),
