...
export class ReactPanel {
	...
	private constructor(extensionPath: string, column: vscode.ViewColumn) {
		...
		this._panel = vscode.window.createWebviewPanel(ReactPanel.viewType, "OpenShift Help", column, {
	...
	private _getHtmlForWebview() {
		...
		const stylePathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'src', 'App.css'));
