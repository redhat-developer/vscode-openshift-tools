...
export enum ProjectOpenshiftIoApiApiKeys {
    BearerToken,
}

export class ProjectOpenshiftIoApi {
    ...
    public setApiKey(key: ProjectOpenshiftIoApiApiKeys, value: string) {
        (this.authentications as any)[ProjectOpenshiftIoApiApiKeys[key]].apiKey = value;
    }
    ...
    public async getAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1APIGroup;  }> {
        const localVarPath = this.basePath + '/apis/project.openshift.io/';
