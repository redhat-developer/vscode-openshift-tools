...
async function main() {
    ...
    console.log(`run-tests: tests: ${tests}`);
    console.log(`run-tests: extension: ${extension}`);
    console.log(`run-tests: extensionRootPath: ${extensionRootPath}`);
    console.log(`run-tests: extensionDevelopmentPath: ${extensionDevelopmentPath}`);
    console.log(`run-tests: extensionTestsPath: ${extensionTestsPath}`);
    console.log(`run-tests: integrationWorkspacePath: ${integrationWorkspacePath}`);
    console.log(`run-tests: unitTestWorkspacePath: ${unitTestWorkspacePath}`);
